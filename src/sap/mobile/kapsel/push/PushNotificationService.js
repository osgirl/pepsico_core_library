sap.ui.define([
	"sap/ui/base/Object",
	"com/pepsico/core/sap/mobile/kapsel/push/PushNotificationException"
], function(Object, PushNotificationException) {
	"use strict";
	return Object.extend("com.pepsico.core.sap.mobile.kapsel.push.PushNotificationService", {
		constructor: function({
			sSmpApplicationId = "",
			sSendNotificationUser = "",
			sSendNotificationPassword = "",
			sRestNotificationServiceUrl = ""
		} = {}) {
			...
			this._sRestNotificationServiceUrl = sRestNotificationServiceUrl;
		...
		sendNotificationAll: function(sTitle, sData) {
			...
			return new Promise(function(resolve, reject) {
				...
				var oRequest = {
					...
					"url": that._sRestNotificationServiceUrl + "/application/" + that._sSmpApplicationId + "/",
					"method": "POST",
					"headers": {
